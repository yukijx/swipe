...
export default function Swipe() {
  ...
  const [profiles, setProfiles] = useState([
    { id: 1, name: 'Alex Tang', major: 'CS, Junior', skills: ['Java', 'Python', 'ADA', 'R'], experience: ['AirLab RA', 'Boeing Intern'], contact: 'alextang@ou.edu', image: require("../../assets/images/user-icon-removebg.png") },
    { id: 2, name: 'Jamie Lee', major: 'EE, Senior', skills: ['C++', 'Embedded Systems'], experience: ['Intel Intern'], contact: 'jamielee@ou.edu', image: require("../../assets/images/user-icon-removebg.png") },
    { id: 3, name: 'Taylor Kim', major: 'Data Science, Junior', skills: ['SQL', 'Machine Learning'], experience: ['Data Analyst Intern'], contact: 'taylorkim@ou.edu', image: require("../../assets/images/user-icon-removebg.png") },
    { id: 4, name: 'Jordan Park', major: 'Cybersecurity, Senior', skills: ['Network Security', 'Python'], experience: ['Cybersecurity Intern'], contact: 'jordanpark@ou.edu', image: require("../../assets/images/user-icon-removebg.png") },
    { id: 5, name: 'Andre Moore', major: 'Meteorology, Senior', skills: ['Numerical Modeling', 'Python', 'Theory'], experience: ['Cybersecurity Intern'], contact: 'andremoore@ou.edu', image: require("../../assets/images/user-icon-removebg.png") },
  ...
  return (
    ...
    <TouchableOpacity style={styles.menuIcon} onPress={() => console.log("Menu Clicked")}>
      <Image source={require("../../assets/images/menu-icon-removebg.png")} style={styles.menuImage} />
    </TouchableOpacity>
