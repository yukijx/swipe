  ...
  return (
    <View style={[styles.container, { backgroundColor }]}>
      ...
      <View style={styles.roleContainer}>
        <Text style={[styles.roleLabel, { color: textColor }]}>I am a:</Text>
        <View style={styles.roleButtons}>
          <TouchableOpacity
            style={[
              styles.roleButton,
              !form.isFaculty ? styles.roleButtonActive : null
            ]}
            onPress={() => setForm({ ...form, isFaculty: false })}
          >
            <Text style={!form.isFaculty ? styles.roleButtonTextActive : styles.roleButtonText}>
              Student
            </Text>
          </TouchableOpacity>
